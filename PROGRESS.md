...
| 1 | metanodes (loop/select) **done** (test_loop/test_select green); remaining: map_over.models, winner_model binding, rerun/reuse, `refract rerun`, remaining spectra agents, 3 library templates, docs/opencode-smoke.md, OpencodeRuntime exec + manual smoke | in progress |
