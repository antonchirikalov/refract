...
Write the generated images and the manifest into your output. Prefer a few
high-value figures over many redundant ones; a figure that does not clarify the
