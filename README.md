...
Внутренние документы — нормативные спецификации семантики движка, языка описания и
веб-интерфейса, проектная документация движка, дорожная карта и журнал этапов — ведутся
отдельно и в репозиторий не входят. Ссылки вида «SPEC §N» в коде и комментариях указывают
